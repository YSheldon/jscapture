                ...
                try {
                    window.lxpc.exebusinessaction('notice', 'SendNotice', '0', JSON.stringify(parm), 0, function (status, Notice, targ) {
                        if (status == 0) {
                            ...
                            var title = Notice['noticeEntity']['title'];
                ...
                try {
                    ...
                    window.lxpc.exebusinessaction('Notice', 'OpenFileDialog', '0', JSON.stringify(parm), 0, function (status, data, targ) {
                        if (status == 0) {
                            ...
                            var str = '<div class="attachInfo"><span id="AttName">' + FileName + ' ' + '</span><span id="AttSize">' + FormatSize(FileSize) + '</span><span id="AttDel" onclick="delAttanch()" style="color: #C6CAD2;cursor: default">取消</span><span id="AttSpeed"></span></div>';
...
//语音信息
    ...
    bindReviceRight: function bindReviceRight(datalist, sNoticeId, record, isself) {
        ...
        var branch = curNotice['creatorMember']['branchPath'];
        ...
        var sName = curNotice['creatorMember']['name']
        ...
        if (typeof (imgstr) != 'undefined' || imgstr != '') {
            ...
            var parm = {resourceList: [{photoResId: imgstr}], type: "Sender"};
...
//语音信息
        ...
        switch (attachtype) {///0 没有附件1 只有文件 2 只有图片附件 3.同时有文件附件和图片附件
            ...
            case 1:
                ...
                var filename = curNotice['noticeEntity']['resourceName'];
            ...
            case 2: //内容图片
                ...
                if (typeof (ImgInContent) != 'undefined' && ImgInContent != '') {
                    ...
                    try {
                        ...
                        var parm = {resourceList: [{photoResId: ImgInContent}]};
                        //_this.imageId=_this.imageId+1;
                        window.lxpc.exebusinessaction('DownloadResource', 'SendContentImage', sNoticeId.toString(), JSON.stringify(parm), 0, function (status, result, targ) {
        ...
        if (attachtype == 1) {//有文件
            ...
            var resId = curNotice['noticeEntity']['resId'],
                filename = curNotice['noticeEntity']['resourceName'];
            ...
            window.lxpc.exebusinessaction('notice', 'QueryNoticeReply', sNoticeId.toString(), JSON.stringify(parm), 0, function (status, datalist, targ) {
                if (status == "0") {
                    ...
                    for (var j = 0; j < list.length; j++) {
                        ...
                        //头像
                        var name = aReplyContent['noticeMember']['name'];
                        ...
                        str += '<div class="replay_detail"><img imagepath="' + imagepath + '" src="./images/defuser.png" alt="">';
                    ...
                    if (_this.typeInfo == '1') {
                        ...
                        $('#content_Re .content_right .replay_list .replay_detail img').each(function (index, ele) {
                            ...
                            if (typeof(imgPath) != 'undefined' && imgPath != '') {
                                var parm = {resourceList: [{photoResId: imgPath}]};
                                _this.imageId = _this.imageId + 1;
                        ...
                        if (status == '0') {
                            ...
                            if (unconfirmList.length > 0) {
                                ...
                                for (var i = 0; i < unconfirmList.length; i++) {
                                    ...
                                    strR += '<li><img imagepath="' + unconfirmList[i]['photoResId'] + '" src="./images/defuser.png" alt=""><span>' + unconfirmList[i]['name'] + '</span></li>'
                                }
                            ...
                            if (confirmList.length > 0) {
                                ...
                                for (var k = 0; k < confirmList.length; k++) {
                                    ...
                                    strR += '<li><img src="./images/defuser.png" alt="" imagepath="'+confirmList[k]['photoResId']+'"><span>' + confirmList[k]['name'] + '</span></li>';
                                }
...
var timer_play=null;
    ...
    //修改通知（确认）
    confirmNotice: function (sNoticeId) {
    ...
    bindAttachment:function(curNotice,newNotice){
        ...
        var  filename = newNotice['noticeEntity']['resourceName'];
        var attachtype = curNotice['noticeEntity']['attachmentType'];
            ...
            case 2: //内容图片
                ...
                if (typeof (ImgInContent) != 'undefined' && ImgInContent != '') {
                    ...
                    try {
                        ...
                        var parm = {resourceList: [{photoResId: ImgInContent}]};
                        //_this.imageId=_this.imageId+1;
                        window.lxpc.exebusinessaction('DownloadResource', 'ContentImage', sNoticeId.toString(), JSON.stringify(parm), 0, function (status, result, targ) {
